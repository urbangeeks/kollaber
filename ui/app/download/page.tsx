    ...
    <div className="min-h-screen p-8">
      <div className="mx-auto max-w-2xl space-y-8">
        ...
        <div className="space-y-3">
          <h2 className="text-sm font-medium uppercase tracking-wide">Download</h2>
          {platforms.map((p) => (
            <Card key={`${p.os}-${p.arch}`}>
              <CardHeader className="flex flex-row items-center gap-3 py-3">
                <CardTitle className="text-sm font-medium">{p.label}</CardTitle>
                <Badge variant="secondary" className="ml-auto">{p.badge}</Badge>
        ...
        {/* Go install */}
        <div className="space-y-3">
          <h2 className="text-sm font-medium uppercase tracking-wide">Install with Go</h2>
        ...
        {/* Quick start */}
        <div className="space-y-3">
          <h2 className="text-sm font-medium uppercase tracking-wide">Quick start</h2>
          <Card>
...
kollaber timeline --env prod`}</pre>
        ...
        <p className="text-muted-foreground text-sm">
          ...
          <Link href={LATEST} className="underline underline-offset-4" target="_blank" rel="noopener noreferrer">
            GitHub Releases
          </Link>
          .
        </p>
